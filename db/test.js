...
var fs = require('fs');
var wstream = fs.createWriteStream('dump.txt');


wstream.write("FF_PLAN_ID" + "\n");
console.log("FF_PLAN_ID");
...
db.each(stmt, function(err, row) {
    ...
    console.log(row.FF_PLAN_ID);
    currRow += 1;
    wstream.write(row.FF_PLAN_ID + "\n");
});
